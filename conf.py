...
project = 'Metatron Discovery Install Docs'
copyright = '2019, SKT'
...
# site base url
site_url = 'https://metatron.app/docs'
...
man_pages = [
    (master_doc, 'metatron-doc-user', 'metatron-doc-user Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'metatron-doc-user', 'metatron-doc-user Documentation',
     author, 'metatron-doc-user', 'One line description of project.',
     'Miscellaneous'),
]
